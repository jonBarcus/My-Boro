...
user_1.news_items.create(category_type_id: 1, headline: "Alibaba I.P.O. May Unleash Global Fight Over Users", url: "http://www.nytimes.com/2014/05/01/technology/after-alibaba-ipo-us-web-giants-may-stop-ignoring-chinese-rivals.html?ref=business")
NewsItem.create(category_type_id: 1, headline: "Facebook to Let Users Limit Data Revealed by Log-Ins", url: "http://www.nytimes.com/2014/05/01/technology/facebook-to-let-users-limit-data-revealed-by-log-ins.html?hpw&rref=technology")
user_2.news_items.create(category_type_id: 2, headline: "Stars’ Newest Must-Have Item: The Clippers", url: "http://www.nytimes.com/2014/05/01/sports/basketball/suddenly-everyone-it-seems-wants-to-buy-the-clippers.html?")
