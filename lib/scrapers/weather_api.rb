class Weather
  ...
  def initialize(location)
    ...
    @weather_instance = HTTParty.get("http://api.wunderground.com/api/#{weather_key}/conditions/q/NY/#{location}.json")
  ...
  def humidity
    current_humidity = @weather_instance["current_observation"]["relative_humidity"]
